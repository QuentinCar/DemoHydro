...
2.
Brancher la batterie et allumer l'interrupteur
...
4.
Sur le pc 
Lancer le fichier Server.py avec Spyder. On a un affichage de la bathymetrie (Scatter et contourf) et le retour de la caméra ou se situe le bateau

5.
La mission se lance automatiquement apres avoir definit les paramètres de calibration

6. 
Pour changer les lignes à suivre : Sous PosRegulV2.py on change le tableau Waypoints (en M)