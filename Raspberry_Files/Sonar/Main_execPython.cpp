...
////////////////////////////////////////////////////////////////////////
//////////////////// Preparation pour execution via Python /////////////


// encapsulation de la fonction 'GetFirstObstacleDist' pour utilisation par Python
//int GetFirstObstacleDist(unsigned char* scanline, unsigned char threshold, double minDist, double maxDist, 
//						 int NBins, int RangeScale, double* pDist)
static PyObject * testext_GetFirstObstacleDist(PyObject *self, PyObject *args) {
    ...
    int RangeScale;
    double* pDist;
    if (!PyArg_ParseTuple(args, "iiiiiii", &scanline, &threshold, &minDist, &maxDist, &NBins, &RangeScale, &pDist))
        return NULL;
    return (PyObject*)Py_BuildValue("i", GetFirstObstacleDist(scanline, threshold, minDist, maxDist, NBins, RangeScale, pDist)));
    };


static PyObject * testext_execPython(PyObject *self, PyObject *args) {
    return (PyObject*)Py_BuildValue("i", execPython());
    };
...
static PyMethodDef testextMethods[] = {
        {"GetFirstObstacleDist", testext_GetFirstObstacleDist, METH_VARARGS},
        {"execPython", testext_execPython, METH_VARARGS},
        {NULL, NULL},
    };
...
PyMODINIT_FUNC inittestext(void) {
    Py_InitModule("Main_execPython", testextMethods);
    };
