...
# =============================================================================
# REGULATION MANOEUVRES POUR SUIVI DE LIGNE (manoeuvre quart de tour)
# =============================================================================
...
# =============================================================================
# Manoeuvre rotation (quart de tour) en trois temps
# =============================================================================
def rotationTroisTemps(X, capTarget, commande_precedente):
    X = X.flatten()
    ...
    if abs(erreurCap) > 0.2:
        ...
        return 'Turning', commande
    
    else:
        return 'End', commande_precedente
...
#                plt.cla()
            ...
            capTarget = X[2,0] + pi/4
            action, commandes = rotationTroisTemps(X, capTarget, commandes)
            
            while action == 'Turning' :                
#                plt.cla()
                plt.xlim((0, 4))
                plt.ylim((0, 3))
                plt.gca().set_aspect('equal', adjustable='box')
